...
| `docs/reports/product/` | 商品レビュー、価格/範囲チェック、LPコピー案、業態別パッケージ | `YYYY-MM-DD-...md` / `YYYY-MM-...md` | 提案前/月次/必要時 | 人間 | 可 | 価格/LP/契約は自動変更しない |
| `docs/reports/outsourcing/` | 外注タスクブリーフ、候補者レビュー、品質レビュー、リスクチェック | `YYYY-MM-DD-...md` / `YYYY-MM-...md` | 外注検討/依頼前/月次 | 人間 | 個別判断 | 実個人情報、秘密情報、ログイン情報を入れない |
| `docs/reports/ai-ops/` | プロンプトレビュー、回帰テスト、AI出力評価、失敗分析、コスト/クォータレビュー | `YYYY-MM-DD-...md` / `YYYY-MM-...md` | 必要時/月次 | 人間 | 可 | 設定変更やモデル変更は自動化しない |
