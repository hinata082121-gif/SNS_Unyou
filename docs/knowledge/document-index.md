...
| AI運用改善部門 | AIの使い方、プロンプト、モデル、評価、改善サイクル | `docs/ai-ops/` | `ai-operating-principles.md`, `prompt-evaluation-framework.md`, `failure-analysis-rules.md` | プロンプト改善、失敗分析、モデル見直し時 | `ai-ops-prompt-review.md`, `ai-failure-analysis.md` | `docs/reports/ai-ops/` |
| Instagram営業・自社SNSコンテンツ更新 | Instagram起点の候補抽出（フォロワー5,000人未満基準・業種拡張）と週1〜2本の自社投稿生成 | `docs/sales/`, `docs/pr/` | `docs/sales-targeting-rules.md`, `docs/pr/self-sns-strategy.md`, `docs/pr/monthly-pr-calendar-template.md`, `docs/pr/post-idea-bank.md` | Instagram営業候補を探す時、重複除外台帳を作る時、自社SNS投稿を作る時 | `instagram-sales-list-builder.md`, `weekly-self-content-builder.md` | `docs/reports/sales/research/`, `docs/reports/pr/content/` |
