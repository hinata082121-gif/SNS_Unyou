...
const task = {
  ...
  metrics: {
    ...
    copyVariantMode: summary.copyVariantMode || 'local_metadata_only',
    copyVariantA: Number(summary.copyVariantA || 0),
    copyVariantB: Number(summary.copyVariantB || 0),
    copyVariantC: Number(summary.copyVariantC || 0),
    copyVariantSheetColumnAdded: Boolean(summary.copyVariantSheetColumnAdded),
