...
$tasks = @(
  ...
  @{ Name="ICHI-Threads-Post-1100"; Script="scripts\windows\tasks\threads-post-11.ps1"; Arguments=""; Trigger=(New-ScheduledTaskTrigger -Daily -At "11:00"); MaxMinutes=10; RestartMinutes=5; RestartCount=2; Wake=$true; Description="ICHI Social Threads 11:00 publish task with duplicate guard." },
  ...
  @{ Name="ICHI-Threads-Post-1900"; Script="scripts\windows\tasks\threads-post-19.ps1"; Arguments=""; Trigger=(New-ScheduledTaskTrigger -Daily -At "19:00"); MaxMinutes=10; RestartMinutes=5; RestartCount=2; Wake=$true; Description="ICHI Social Threads 19:00 publish task with duplicate guard." },
